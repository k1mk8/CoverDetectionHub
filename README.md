...
| [BYTECOVER: COVER SONG IDENTIFICATION VIA MULTI-LOSS TRAINING](https://arxiv.org/pdf/2010.14022v2) | This paper from 2021 introduces new feature learning method for song cover identification task. It is build on classical ResNet model with improvements designed for CSI. In a set of experiments, authors demonstrate its effectiveness and efficiency. They evaluate the method on multiple datasets including DaTacos. In repository [bytecover](https://github.com/Orfium/bytecover) there is shared implementation of this method with the best trained model checkpoints. Thoughts: No transformer in method which may imly worse results than CoverHunter. |
